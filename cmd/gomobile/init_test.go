...
go install -p={{.NumCPU}} -x github.com/SpiderOak/mobile/gl
go install -p={{.NumCPU}} -x github.com/SpiderOak/mobile/app
go install -p={{.NumCPU}} -x github.com/SpiderOak/mobile/exp/app/debug{{end}}
