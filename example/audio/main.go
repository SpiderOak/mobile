...
//
// See http://godoc.org/github.com/SpiderOak/mobile/cmd/gomobile to install gomobile.
//
// Get the audio example and use gomobile to build or install it on your device.
//
//   $ go get -d github.com/SpiderOak/mobile/example/audio
//   $ gomobile build github.com/SpiderOak/mobile/example/audio # will build an APK
//
//   # plug your Android device to your computer or start an Android emulator.
//   # if you have adb installed on your machine, use gomobile install to
//   # build and deploy the APK to an Android target.
//   $ gomobile install github.com/SpiderOak/mobile/example/audio
//
// Additionally, you can run the sample on your desktop environment
// by using the go tool.
//
//   $ go install github.com/SpiderOak/mobile/example/audio && audio
//
...
import (
	...
	"github.com/SpiderOak/mobile/exp/audio"
	"github.com/SpiderOak/mobile/exp/f32"
